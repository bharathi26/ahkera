...
#
# Django settings for Ahkera project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
     ('admin', 'kontakt@thilo-fromm.de'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'Ahkera'             # Or path to database file if using sqlite3.
...
SECRET_KEY = '7_e4$muz91^iv2o$k=tn8&!%kz8+h4(n9io+qgoky=vle9!y78'
